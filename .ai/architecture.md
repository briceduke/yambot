...
**In (first cut):** SoundCloud track URLs through existing `/play`. Engine source module + dispatcher; bot play path unchanged at the seam. (Grill 2026-08-22: `.ai/runs/2026-08-22-grill-slice-3-source-breadth.md`.)
