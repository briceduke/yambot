---
description: Plain English writing standard for all agent-written text.
paths:
  - "**/*"
---
...
Use plain English in rules, skills, docs, comments, commit messages, CLI output, and plan text.
...
Also follow `.ai/rules/raptor-milspec.md`: fewer parts, vertical slices, no speculative extras.
